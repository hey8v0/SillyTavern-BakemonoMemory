...
- 当前版本 `1.7.0-beta.2`，开发与发布分支为 `main`；测试分支已合入。实际提交、未提交修改和远端状态先查 Git，不从旧对话推断。
...
- 发布基线：412 项 Node 回归、130 个运行模块语法解析、完整 CSS、13 组离线界面／存储检查通过。提示词测试执行入口实际回调及真实全局初始化。具体覆盖、运行方式与测量见 [TESTING_v1.7.0.md](TESTING_v1.7.0.md)。
