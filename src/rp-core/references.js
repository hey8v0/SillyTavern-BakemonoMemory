...
const creationActions = new Set(['person_created', 'person_registered', 'relationship_established', 'relationship_recorded', 'plan_proposed', 'promise_created', 'item_acquired', 'item_registered', 'location_created']);
